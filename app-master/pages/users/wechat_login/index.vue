<template>
	<view class="page" :data-theme="theme" :style="{'background-image': `url(${backBg})`}">
		...
		<block v-if="isUp">
			<mobileLogin :theme="theme" :isUp="isUp" @close="maskClose" :authKey="authKey" @wechatPhone="wechatPhone"></mobileLogin>
		</block>
		...
		onLoad(options) {
			...
			switch (app.globalData.theme) {
				...
				case 'theme3':
					...
					break;
				case 'theme4':
					this.backBg = `${this.urlDomain}crmebimage/preset/wxbj4.png`;
					break;
				case 'theme5':
