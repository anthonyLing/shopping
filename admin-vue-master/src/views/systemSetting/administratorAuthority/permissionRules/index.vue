  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix" ref="tableheader">
        <el-form v-hasPermi="['platform:menu:list']" :model="queryParams" :inline="true">
          <el-form-item label="菜单名称">
            <el-input v-model.trim="name" placeholder="请输入菜单名称" clearable size="small" />
          </el-form-item>
        ...
        <el-table-column label="操作" align="center" min-width="130" fixed="right">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['platform:menu:update', 'platform:admin:role:info']"
              >修改</el-button
            >
            <el-button size="mini" type="text" @click="handleAdd(scope.row)" v-hasPermi="['platform:menu:add']"
              >新增</el-button
            >
            <el-button size="mini" type="text" @click="handleDelete(scope.row)" v-hasPermi="['platform:menu:delete']"
              >删除</el-button
            >
          </template>
        </el-table-column>
