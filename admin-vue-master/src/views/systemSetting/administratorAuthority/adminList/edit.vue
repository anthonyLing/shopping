<template>
  <div>
    <el-form ref="pram" :model="pram" :rules="rules" label-width="100px" @submit.native.prevent>
      ...
      <el-form-item required label="管理员密码" prop="pwd">
        <el-input
      ...
      <el-form-item v-if="pram.pwd" required label="确认密码" prop="repwd">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        pwd: [{ required: true, message: '请填写管理员密码', trigger: ['blur', 'change'] }],
  ...
  methods: {
    ...
    handlerPwdInput(val) {
      ...
      this.rules.pwd = [
        { required: true, message: '请填写管理员密码', trigger: ['blur', 'change'] },
