<template>
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix" v-hasPermi="['platform:retail:store:people:list']">
        <div class="container">
        ...
        <el-table-column label="操作" min-width="150" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              size="small"
              class="mr10"
              @click="onSpread(scope.row.id, 'man', '推广人')"
              v-hasPermi="['platform:retail:store:sub:user:list']"
              >推广人</el-button
            >
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item
                  @click.native="onSpreadOrder(scope.row.id, 'order', '推广订单')"
    ...
    <el-dialog :title="titleName + '列表'" :visible.sync="dialogVisible" width="900px" :before-close="handleClose">
      <div class="container">
        <el-form size="small" label-width="100px">
          <el-form-item key="1" label="时间选择：" class="width100">
            <el-radio-group
