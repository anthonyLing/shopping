    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container">
          <el-form size="small" label-width="120px" inline>
            <el-form-item label="审核状态：" style="display: block">
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="small" highlight-current-row>
        ...
        <el-table-column label="操作" min-width="150" fixed="right">
          <template slot-scope="scope">
            <el-button
              v-hasPermi="['platform:mp:live:room:list']"
              type="text"
              size="small"
              class="mr10"
              @click="onStudioDetails(scope.row, false)"
              >详情</el-button
            >
            <el-button
            ...
            >
            <el-button
              v-hasPermi="['platform:mp:live:room:delete']"
              type="text"
              size="small"
