<template>
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix" v-hasPermi="['platform:finance:summary:financial:statements']">
        <div class="container">
        ...
        <el-col :span="21">
          <el-col :span="10">
            <div class="grid-content">
              ...
              <div class="list">
                <el-card class="mb10" body-style="background-color: #F9F9F9;padding: 20px 15px;">
          ...
          <el-col :span="10">
            <div class="grid-content">
              ...
              <div class="list">
                <el-card body-style="background-color: #F9F9F9;padding: 20px 15px;">
                  <el-row class="item mb20">
