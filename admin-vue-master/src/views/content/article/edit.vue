    ...
    <el-card class="box-card">
      <div class="components-container">
        <el-form ref="pram" label-width="150px" :model="pram">
          ...
          >
            <el-input v-model.trim="pram.title" placeholder="标题" maxlength="100" />
          </el-form-item>
          <el-form-item
            label="作者"
            prop="author"
          ...
          >
            <el-input v-model.trim="pram.author" placeholder="作者" maxlength="20" />
          </el-form-item>
          <el-form-item
            label="文章分类"
            :rules="[{ required: true, message: '请选择分类', trigger: ['blur', 'change'] }]"
          >
            <el-select v-model.trim="pram.cid" placeholder="请选择" style="width: 100%">
          ...
          <el-form-item label="是否Banner">
            <el-switch v-model.trim="pram.isBanner" />
          </el-form-item>
          <el-form-item label="是否热门">
            <el-switch v-model.trim="pram.isHot" />
          </el-form-item>
          <el-form-item>
            <el-button
              type="primary"
