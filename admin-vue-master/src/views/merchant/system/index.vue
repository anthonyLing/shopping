    ...
    <el-card class="box-card">
      ...
      >
        <el-form-item label="菜单名称" prop="menuName">
          <el-input v-model.trim="queryParams.name" placeholder="请输入菜单名称" clearable size="small" />
        </el-form-item>
        <el-form-item label="类型" prop="menuType">
          <el-select v-model.trim="queryParams.menuType" placeholder="类型" clearable size="small">
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['platform:merchant:menu:add']"
            >新增</el-button
          >
        </el-col>
        <el-col :span="1.5">
        ...
        <el-table-column label="操作" align="center" min-width="130" fixed="right">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['platform:merchant:menu:update']"
              >修改</el-button
            >
            <el-button size="mini" type="text" @click="handleAdd(scope.row)" v-hasPermi="['platform:merchant:menu:add']"
              >新增</el-button
            >
            <el-button
              size="mini"
              ...
              v-hasPermi="['platform:merchant:menu:delete']"
              >删除</el-button
            >
          </template>
        </el-table-column>
      ...
      <el-dialog :title="title" :visible.sync="open" width="680px" append-to-body :close-on-click-modal="false">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button
            type="primary"
            @click="submitForm"
            v-hasPermi="['platform:merchant:menu:update', 'platform:merchant:menu:add']"
            >保存</el-button
          >
