  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container" v-hasPermi="['platform:express:list']">
          <el-form ref="form" inline :model="form">
            <el-form-item label="关键字：">
              <el-input v-model.trim="form.keywords" placeholder="请输入关键字" class="selWidth" size="small" clearable>
        ...
        <el-table-column prop="address" fixed="right" min-width="120" label="操作">
          <template slot-scope="scope">
            <!-- <el-button
              ...
              v-hasPermi="['platform:express:info']"
              >收件网点名称编辑</el-button
            >
            <el-button
              ...
              >月结账号编辑</el-button
            > -->
            <el-button type="text" size="small" @click="bindEdit(scope.row)" v-hasPermi="['platform:express:update']"
              >编辑</el-button
            >
          </template>
    ...
    <el-dialog title="编辑物流公司" :visible.sync="dialogVisible" width="700px" :before-close="handleClose">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submit('formData')" v-hasPermi="['platform:express:update']">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
