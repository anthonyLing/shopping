    ...
    <div :style="boxStyle" class="mobile-page paddingBox" :class="bgStyle === 0 ? '' : 'pageOn'">
      <div class="home_product">
        ...
        <template v-if="itemStyle == 0">
          <div class="list-wrapper itemA" v-if="goodslist.length > 0">
            <div
              class="item"
                ...
                <div class="hd">
                  <div class="text">
                    <div class="title line2">
                      <span v-if="merTypeShow" class="label" :style="labelColor">自营</span>
        ...
        <template v-if="itemStyle == 1">
          <div class="list-wrapper itemC" v-if="goodslist.length > 0" :style="{ gridGap: contentConfig + 'px' }">
            <div class="item auto" :style="contentStyle" v-for="(item, index) in goodslist" :key="index">
              ...
              <div class="info">
                <div class="hd line2">
                  <span class="label" :style="labelColor" v-if="merTypeShow">自营</span>
        ...
        <template v-if="itemStyle == 2">
          <div class="list-wrapper itemB listC" :style="{ gridGap: contentConfig + 'px' }" v-if="goodslist.length > 0">
        ...
        <template v-if="itemStyle == 3">
          <div class="listBig" v-if="goodslist.length > 0">
            <div
              class="itemBig"
              v-for="(item, index) in goodslist"
              :key="index"
