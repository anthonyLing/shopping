...
export default {
  ...
  methods: {
    ...
    setProConfig() {
      ...
      this.configObj.tabItemConfig.list[this.configObj.tabItemConfig.tabVal].brandGoodsList =
        this.configObj.activeValueBrand.goodsList;
      this.configObj.tabItemConfig.list[this.configObj.tabItemConfig.tabVal].selectConfigList =
        this.configObj.selectConfig.goodsList;
      this.configObj.tabItemConfig.list[this.configObj.tabItemConfig.tabVal].merList =
        this.configObj.activeValueMer.goodsList;
    },
  },
};
</script>
