      ...
      <div class="flex">
        ...
        <div class="leftModel">
          <div v-show="currentPage == 'home'" class="current_home">
            ...
            <div v-hasPermi="['platform:system:group:list']" class="model_banner cur_pointer">
            ...
            <div class="model_nav cur_pointer" :class="{ select_ctive: shows == 3 }">
              ...
              <template v-if="typeName !== 'bottomNavigation' && checkPermi(['platform:system:group:list'])">
                <div v-for="(item, index) in menuList" :key="index" class="item">
                  ...
                  <div class="picBox" v-if="typeName !== 'indexNews'">
                    <div class="img-box flex justify-center align-center" @click="modalPicTap('1', 'duo', index)">
