    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container mt-1">
          <el-form :inline="true">
            <el-form-item label="分类名称：" class="mr10">
              <el-input v-model.trim="name" placeholder="请输入分类名称" class="selWidth" size="small" clearable>
                <el-button slot="append" icon="el-icon-search" @click="getList(1)" size="small" />
              </el-input>
            </el-form-item>
            <el-form-item label="显示状态：" class="mr10">
              <el-select
        ...
        <el-table-column label="操作" min-width="130" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['platform:community:category:update']"
              >编辑</el-button
            >
            <el-button
              size="small"
              ...
              v-hasPermi="['platform:community:category:delete']"
              >删除</el-button
            >
          </template>
        </el-table-column>
