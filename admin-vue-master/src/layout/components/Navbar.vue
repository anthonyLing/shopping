    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <router-link :to="{ path: '/operation/maintain/user' }" v-if="!isPhone">
            <el-dropdown-item>个人中心</el-dropdown-item>
          </router-link>
          <el-dropdown-item @click.native="setting = true">
            <span>布局设置</span>
          </el-dropdown-item>
          <el-dropdown-item v-if="checkPermi(['platform:logout'])" @click.native="logout">
            <span>退出</span>
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
...
export default {
  ...
  data() {
    return {
      ...
      JavaInfo: Cookies.get('JavaInfo') ? JSON.parse(Cookies.get('JavaInfo')) : {},
    };
  },
  watch: {
    show(value) {
  ...
  methods: {
    ...
    async logout() {
      ...
      this.$store.commit('settings/SET_FrontDomain', '');
      this.$store.commit('settings/SET_mediaDomain', '');
    },
  },
};
</script>
