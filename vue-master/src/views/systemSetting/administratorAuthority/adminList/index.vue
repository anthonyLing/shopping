<template>
  <div class="divBox">
    <el-card class="box-card">
      <el-form inline size="small" @submit.native.prevent v-hasPermi="['merchant:admin:list']">
        <el-form-item>
        ...
        <el-form-item>
          <el-input v-model.trim="listPram.realName" placeholder="姓名或者账号" clearable class="selWidth" />
        </el-form-item>
        <el-form-item>
