<template>
  ...
  >
      ...
      <el-table ref="multipleTable" :data="ManyAttrValue" tooltip-effect="dark" style="width: 100%" size="mini">
        <el-table-column label="选择" width="50">
          <template slot-scope="scope">
            <el-radio v-model="radio" :label="scope.row" @change.native="changeType(scope.row)">&nbsp; </el-radio>
          </template>
        </el-table-column>
    ...
    <el-form-item label="评价星级：" prop="star" class="productScore">
      <el-rate v-model="formValidate.star"></el-rate>
    </el-form-item>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        star: [{ required: true, validator: checkProductScore, trigger: 'blur' }],
      },
