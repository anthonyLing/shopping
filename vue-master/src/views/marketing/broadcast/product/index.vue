          ...
          <el-form size="small" label-width="100px">
            <el-form-item label="状态：">
              <el-radio-group v-model="tableForm.reviewStatus" type="button" @change="getList(1)">
                ...
                <el-radio-button label="0">商户创建</el-radio-button>
      ...
      <el-table v-loading="listLoading" :data="tableData.data" style="width: 100%" size="small" highlight-current-row>
        ...
        <el-table-column label="操作" min-width="150" fixed="right">
          <template slot-scope="scope">
            ...
            <!--size="small"-->
            <!--class="mr10"-->
            <!--@click="onProDetails(scope.row)"-->
            <!--&gt;详情</el-button>-->
            <el-button
              v-hasPermi="['merchant:mp:live:goods:sort']"
              type="text"
              size="small"
              class="mr10"
            ...
            >
            <el-button
              v-hasPermi="['merchant:mp:live:goods:edit']"
              type="text"
              size="small"
              class="mr10"
            ...
            >
            <el-button
              v-hasPermi="['merchant:mp:live:goods:delete']"
              type="text"
              size="small"
