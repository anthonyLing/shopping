<template>
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix" v-hasPermi="['merchant:pay:component:product:list']">
        <div class="container">
          <el-form inline>
        ...
        <el-table-column label="操作" min-width="150" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['merchant:pay:component:product:puton']"
              >上架</el-button
            >
            <el-button
              ...
              v-hasPermi="['merchant:pay:component:product:putdown']"
              >下架</el-button
            >
            <el-button
              type="text"
              ...
              v-hasPermi="['merchant:pay:component:product:delete']"
              >删除</el-button
            >
          </template>
        </el-table-column>
