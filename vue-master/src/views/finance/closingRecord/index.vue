    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container">
          <el-form size="small" inline label-width="100px">
            ...
            <el-form-item v-hasPermi="['merchant:finance:closing:page:list']" label="审核状态：">
            ...
            <el-form-item v-hasPermi="['merchant:finance:closing:page:list']" label="到账状态：">
              <el-select
            ...
            <el-form-item v-hasPermi="['merchant:finance:closing:page:list']" label="结算类型：">
              <el-select
            ...
            <br />
            <el-form-item v-hasPermi="['merchant:finance:closing:page:list']" label="结算单号：" class="width100">
              <el-input
      ...
      <el-table v-loading="listLoading" tooltip-effect="dark" :data="tableData.data" style="width: 100%" class="table">
        ...
        <el-table-column label="到账状态" min-width="120">
          <template slot-scope="scope">
            <span>{{ scope.row.accountStatus == 1 ? '已到账' : '未到账' }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" min-width="70" fixed="right" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              @click="transferDetail(scope.row.closingNo)"
              >结算信息</el-button
            >
          </template>
        </el-table-column>
    ...
    <el-dialog v-if="transferDialogVisible" title="申请结算:" :visible.sync="transferDialogVisible" width="700px">
      <div class="box-container" v-loading="loadingBaseInfo">
        <div class="acea-row">
          ...
          <el-form ref="baseInfoform" :model="baseInfoform" label-width="112px" size="mini">
            <el-form-item label="申请金额：" :rules="[{ required: true, message: '请输入申请金额', trigger: 'blur' }]">
            ...
            <el-form-item label="金额说明：" class="transferMinAmount">
              <el-alert
                effect="dark"
                :closable="false"
                :title="`最低可提现额度${transferBaseInfo.transferMinAmount}元;最高可提现额度${transferBaseInfo.transferMaxAmount}元`"
                type="warning"
              >
              </el-alert>
            </el-form-item>
            <el-form-item label="备注: " label-width="105px">
              <el-input v-model.trim="baseInfoform.mark" style="margin-left: 7px" type="textarea" :rows="2"></el-input>
            </el-form-item>
            <el-form-item>
              <el-button
                :disabled="
